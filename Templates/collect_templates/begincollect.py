# begincollect.py
# 模板采集工具 - 开始游戏按钮数字采集器
# 功能：通过GUI界面采集开始游戏按钮区域的数字模板，用于检测游戏开始
...
# ===== 模板保存目录 =====
# 开始游戏按钮数字模板保存的文件夹
TEMPLATE_DIR = 'Templates/begin_img'
...
# ===== 截图区域定义 =====
# 定义开始游戏按钮区域的截图位置（请根据你的屏幕实际位置调整）
# 格式：(x坐标, y坐标, 宽度, 高度)
REGION = (980 + x_o, 415 + y_o, 100, 30)
...
# 创建主窗口
root = tk.Tk()
root.title("模板采集器 - 开始游戏按钮数字采集")
root.geometry("600x400")

# 标题说明
title_label = tk.Label(root, text="=== 开始游戏按钮模板采集器 ===\n请点击下方按钮采集数字模板\n采集前请手动在屏幕上显示对应数字", font=("Arial", 14))
