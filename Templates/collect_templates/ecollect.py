# ecollect.py
# 模板采集工具 - 能量值数字采集器
# 功能：通过GUI界面采集能量值区域的数字模板，用于能量值识别
...
# ===== 截图区域定义 =====
# 定义能量值显示区域的截图位置（请根据你的屏幕实际位置调整）
# 格式：(x坐标, y坐标, 宽度, 高度)
REGION = (680 + x_o, 680 + y_o, 60, 30)  # 示例：能量值显示区域
...
# 创建主窗口
root = tk.Tk()
root.title("模板采集器 - 能量值数字采集")
root.geometry("600x400")

# 标题说明
title_label = tk.Label(root, text="=== 能量值模板采集器 ===\n请点击下方按钮采集数字模板\n采集前请手动在屏幕上显示对应数字", font=("Arial", 14))
