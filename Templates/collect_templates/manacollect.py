# manacollect.py
# 模板采集工具 - 法力值数字采集器
# 功能：通过GUI界面采集法力值区域的数字模板，用于法力值识别
...
# ===== 截图区域定义 =====
# 定义法力值显示区域的截图位置（请根据你的屏幕实际位置调整）
# 格式：(x坐标, y坐标, 宽度, 高度)
REGION = (1448 + x_o, 560 + y_o, 45, 30)  # 示例：法力值显示区域
...
# 创建主窗口
root = tk.Tk()
root.title("模板采集器 - 法力值数字采集")
root.geometry("600x400")

# 标题说明
title_label = tk.Label(root, text="=== 法力值模板采集器 ===\n请点击下方按钮采集数字模板\n采集前请手动在屏幕上显示对应数字", font=("Arial", 14))
