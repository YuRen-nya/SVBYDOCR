...
# 加载数据集
train_dir = 'ms/prepared_dataset2/train'
val_dir = 'ms/prepared_dataset2/val'
...
# 保存模型
torch.save(model.state_dict(), 'image_classifier.pth2')
print('模型已保存')
...
# 加载保存的模型权重
model.load_state_dict(torch.load('image_classifier2.pth'))
